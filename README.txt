AI Usage 위젯
=============
Windows에서 GPT·Cursor 잔여 사용량을 보는 작은 위젯입니다.

이 위젯은 OpenAI(ChatGPT·Codex)·Cursor와 제휴되지 않은 비공식 도구입니다. 공식 앱이 아니며, 사용량 조회는 언제든 실패하거나 바뀔 수 있습니다. 소스 라이선스는 LICENSE(MIT)입니다.
...
7) 표시할 서비스(GPT / Cursor)를 고릅니다. 로그인이 없으면 설치·로그인 창을 띄울 수 있습니다.
