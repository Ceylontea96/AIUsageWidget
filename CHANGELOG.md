...
### Changed
- 카드와 칩의 활동 상태가 같으면 불필요한 화면 표시 확인과 애니메이션 예약 처리를 생략합니다. 활동 시작·종료, 화면 복귀와 중단된 애니메이션의 재예약은 유지합니다.

## [3.11.5] - 2026-09-27

### Changed
- 한 줄 모드의 사용량 칩에 현재 표시값과 같은 수치가 들어오면 불필요한 길이 애니메이션과 이미지 생성을 생략합니다. 실제 수치 변화와 활동 중 빛 효과는 계속 표시합니다.
